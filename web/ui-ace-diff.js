...
/**
 * Binds a ACE Diff Editor widget
 */
angular.module('ui.ace-diff', [])
  .constant('uiAceDiffConfig', {})
  .directive('uiAceDiff', ['uiAceDiffConfig', function (uiAceDiffConfig) {
    ...
    return {
      ...
      link: function (scope, elm, attrs, ngModel) {
        ...
        /**
         * Corresponds the uiAceDiffConfig ACE configuration.
         * @type object
         */
        var options = uiAceDiffConfig.ace || {};
